...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonCard, IonMenuButton, IonButtons, IonButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule, IonCard, IonButtons, IonMenuButton, IonButton]
})
