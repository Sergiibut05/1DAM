const qobjects = [
  ...
  {
    question: "What is the purpose of the '@City' parameter in the following stored procedure?\n\n<code>CREATE PROCEDURE SelectCustomers @City nvarchar(30)\nAS\nSELECT * FROM Customers WHERE City = @City GO;</code>",
    options: [
