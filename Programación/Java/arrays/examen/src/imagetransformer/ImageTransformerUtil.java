...
public class ImageTransformerUtil {
    ...
    public static int[][] rotarDerecha(int[][] matriz) {
        int[][] RotadaDerecha = new int[matriz.length][matriz[0].length];

        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[0].length; j++) {
                RotadaDerecha[j][matriz.length-i-1] = matriz[i][j];
            }
        }

        return RotadaDerecha;
    }
    ...
    public static int[][] rotarIzquierda(int[][] matriz) {
        int[][] RotadaIzquierda = new int[matriz.length][matriz[0].length];

        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[0].length; j++) {
                RotadaIzquierda[matriz.length-i-1][j] = matriz[j][i];
            }
        }

        return RotadaIzquierda;
    }
    ...
    public static int[][] espejoHorizontal(int[][] matriz) {
        int[][] EspejoHorizontal = new int[matriz.length][matriz[0].length];

        for(int i = 0; i < matriz.length; i++){
            for(int j = 0; j < matriz[0].length; j++){
                EspejoHorizontal[i][matriz.length-j-1] = matriz[i][j];
            }
        }
    ...
    public static int[][] espejoVertical(int[][] matriz) {
        int[][] EspejoVertical = new int[matriz.length][matriz[0].length];

        for(int i = 0; i < matriz.length; i++){
            for(int j = 0; j < matriz[0].length; j++){
                EspejoVertical[matriz.length-i-1][j] = matriz[i][j];
            }
        }
